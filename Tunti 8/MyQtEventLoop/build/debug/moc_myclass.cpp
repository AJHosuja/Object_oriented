...
QT_MOC_LITERAL(3, 23, 13), // "myFirstSignal"
QT_MOC_LITERAL(4, 37, 19) // "myFirstSlotFunction"

    },
    "MyClass\0finishProgram\0\0myFirstSignal\0"
    "myFirstSlotFunction"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myFirstSignal(); break;
        case 2: _t->myFirstSlotFunction(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClass::finishProgram)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyClass::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClass::myFirstSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyClass::finishProgram()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyClass::myFirstSignal()
{
